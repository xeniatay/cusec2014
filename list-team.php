...
$team = array(
    ...
    array(
        'name' => 'Sami Jaber',
        'title' => 'McGill University Head Delegate',
        'link' => NULL,
        'img' => 'sami-jaber.png',
