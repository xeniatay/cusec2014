        ...
        <div class='page-team' id='team'>
            <div class='container'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/mohammed-chamma.jpg' alt='Mohammed Chamma'/>
                    <span class='member-name'>
                        <a href='http://github.com/mef51' title='Mohammed Chamma - Github'>
                            Mohammed Chamma
                        </a>
                    </span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/dominic-charley-roy.png' alt='Dominic Charley-Roy'/>
                    <span class='member-name'>
                        <a href='http://github.com/jokeoftheweek' title='Dominic Charley-Roy - Github'>
                            Dominic Charley-Roy
                        </a>
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/nataly-sheinin.jpg' alt='Nataly Sheinin'/>
                    <span class='member-name'>
                        <a href='http://ca.linkedin.com/in/natalysheinin' title='Nataly Sheinin'>
                            Nataly Sheinin
                        </a>
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/michael-lakhia.jpg' alt='Michael Lakhia'/>
                    <span class='member-name'>
                        <a href='http://github.com/mlakhia' title='Michael Lakhia'>
                            Michael Lakhia
                        </a>
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/julian-horvat.jpg' alt='Julian Horvat'/>
                    <span class='member-name'>
                        <a href='http://github.com/jhorvat' title='Julian Horvat - Github'>
                            Julian Horvat
                        </a>
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/alex-selesse.jpg' alt='Alex Selesse'/>
                    <span class='member-name'>
                        <a href='http://github.com/selesse' title='Alex Selesse'>
                            Alex Selesse
                        </a>
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/santiago-gil.jpg' alt='Santiago Gil'/>
                    <span class='member-name'>
                        Santiago Gil
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/alex-coco.jpg' alt='Alex Coco'/>
                    <span class='member-name'>
                        Alex Coco
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/bowen-xu.jpg' alt='Bowen Xu'/>
                    <span class='member-name'>
                        Bowen Xu
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/danielle-pham.jpg' alt='Danielle Pham'/>
                    <span class='member-name'>
                        Danielle Pham
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/sami-jaber.jpg' alt='Sami Jaber'/>
                    <span class='member-name'>
                        Sami Jaber
                    </span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/david-kua.jpg' alt='David Kua'/>
                    <span class='member-name'>
                        <a href='http://github.com/dkua' title='David Kua'>
                            David Kua
                        </a>
                    </span>
                    <span class='member-pos'></span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/matthew-leavitt.jpg' alt='Matthew Leavitt'/>
                    <span class='member-name'>
                        Matthew Leavitt
                    </span>
                    <span class='member-pos'></span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/samira-el-rayyes.jpg' alt='Samira El-Rayyes'/>
                    <span class='member-name'>
                        <a href='http://linkedin.com/in/samiraelrayyes' title='Samira El-Rayyes'>
                            Samira El-Rayyes
                        </a>
                    </span>
                    <span class='member-pos'></span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/patrick-nguyen.jpg' alt='Patrick Nguyen'/>
                    <span class='member-name'>
                        Patrick Nguyen
                    </span>
                    <span class='member-pos'>Concordia - HD</span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/saif-myageri.jpg' alt='Saif Myageri'/>
                    <span class='member-name'>
                        Saif Myageri
                    </span>
                    <span class='member-pos'></span>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/miguel-ocampo-gooding.jpg' alt='Miguel Ocampo-Gooding'/>
                    <span class='member-name'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/alykhan-kanji.jpg' alt='Alykhan Kanji'/>
                    <span class='member-name'>
                        <a href='http://alykhan.com' title='Alykhan Kanji'>
                            Alykhan Kanji
                        </a>
                    </span>
                    <span class='member-pos'></span>
                    <span class='member-desc'>
                        Alykhan is a third year Software Engineering student at the University of Waterloo. He has attended CUSEC annually and is a Head Delegate this year. <a href="http://twitter.com/alykhank" title="Alykhan Kanji - Twitter">Alykhan</a> is enthusiastic about Open Data and mobile development. He has experience developing mobile apps and websites.
                    </span>
                </div>

                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/vaughan-hilts.jpg' alt='Vaughan Hilts'/>
                    <span class='member-name'>
                        <a href='http://github.com/hilts-vaughan' title='Vaughan Hilts'>
                            Vaughan Hilts
                        </a>
                    </span>
                    <span class='member-pos'>
                        Wilfrid Laurier Head Delegate
                    </span>
                    <span class='member-desc'>
                ...
                <div class='team-member'>
                    <img class='member-pic' src='<?php echo get_template_directory_uri(); ?>/library/images/team/stephanie-zeidan.jpg' alt='Stephanie Zeidan'/>
                    <span class='member-name'>
                        Stephanie Zeidan
                    </span>
                    <span class='member-pos'></span>
