...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/library/images/cusec-fb.png"/>
		<link rel="image_src" href="<?php echo get_template_directory_uri(); ?>/library/images/cusec-fb.png"/>
